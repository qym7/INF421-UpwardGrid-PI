...
public class Node  implements Comparable<Node>
{
	...
	public int num_intersection;
	public Color color;

		public Node(Node node)
		{
			this.p = new GridPoint_2(node.p.x, node.p.y);
	    ...
	    public String toString(){
	        return "v: tag"+tag+" - id"+this.index+" - "+this.p+"- level: "+this.level;
	    }

	    public String fullToString(){
	        return "v"+this.index+" - "+this.p+" - label: "+this.label + " - level: " +this.level;
	    }
		...
		{
			return Integer.compare(this.level, v.level);
	    }
