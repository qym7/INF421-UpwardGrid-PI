...
public class ComputeUpwardGridDrawing {
	...
	public static void main(String[] args) {
		...
		try
		{
			FileOutputStream file_os = new FileOutputStream("./result/result_1.data", true);
			...
			file_out.println(" Init : " + crossing_init);
			file_out.println(" End :  " + crossings_end);
		}
		catch (Exception e)
		{
		...
		try
		{
			FileOutputStream file_os = new FileOutputStream("./result/test_result_4.data", true);
			PrintStream file_out = new PrintStream(file_os);
		...
		GraphWriter_Json.write(g, GraphRenderer.drawingWidth, GraphRenderer.drawingHeight, "./output/"+inputFile);
