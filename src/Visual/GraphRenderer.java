    ...
    public static GridPoint_2 a,b; // 
	  ...
	  public void setup() {
		  if(sizeX<=0 || sizeY<=0) {
			  ...
			  System.out.println("WARNING: please do NOT run the class Visual.GraphRenderer");
			  System.out.println("to launch the viewer, run the class Visual.ComputeUpwardGridDrawing");
			  System.exit(0);
		  }
	  ...
	  public void keyPressed(){
		  switch(key) {
		  case('q'):this.zoom(1.2); break;
		  case('e'):this.zoom(0.8); break;
		  case('o'):this.zoom(250); break;
		  case('p'):this.zoom(0.002); break;
		  case('a'):this.translateBox(-2, 0);; break;
		  case('d'):this.translateBox(2, 0);; break;
		  case('s'):this.translateBox(0, -2);; break;
		  case('w'):this.translateBox(0, 2);; break;

		  case('u'):this.zoom(1.2); break;
		  case('i'):this.zoom(0.8); break;
		  case('h'):this.translateBox(-2, 0);; break;
		  case('l'):this.translateBox(2, 0);; break;
		  case('j'):this.translateBox(0, -2);; break;
		  case('k'):this.translateBox(0, 2);; break;
		  }
	  }
	  ...
	  public void mouseDragged() {
		...
		public int[] getCoordinates(GridPoint_2 v) {
		  ...
		  public void drawOptions() {
			String label="press 'q/u' or 'e/i' buttons for zooming\n"; // text to show
			label=label+"press 'a/h' or 'd/l' to move the layout horizontally\n";
			label=label+"press 'w/j' or 's/k' to move the layout vertically\n";
